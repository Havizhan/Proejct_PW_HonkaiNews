...
<head>
    ...
    <title>Edit Berita - Honkai Star Rail News</title>
    ...
    <main class="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-10 flex-grow">
        <div class="max-w-2xl mx-auto">
            <div class="flex items-center mb-6 sm:mb-8">
                ...
                <h1 class="text-2xl sm:text-3xl font-bold text-primary">Edit Berita</h1>
            </div>
            ...
            <!-- Edit Form -->
            <form action="{{ route('news.update', $news->id) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-xl shadow-md p-6 sm:p-8">
                @csrf
                @method('PUT')
                <div class="space-y-6">
                    <!-- Form Judul -->
                    ...
                    <div>
                        ...
                        <textarea id="deskripsi" 
                                  ...
                                  required 
                                  class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary transition duration-300"
                                  style="white-space: pre-wrap;">{{ old('deskripsi', $news->deskripsi) }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" 
                               id="hashtag" 
                               name="hashtag" 
                               value="{{ old('hashtag', $news->hashtag) }}" 
                    ...
                    <div>
                        ...
                        @if($news->gambar)
                            <div class="mb-4">
                                <img src="{{ asset($news->gambar) }}" 
                                     alt="Gambar saat ini" 
                                     class="max-w-full h-auto max-h-64 object-cover rounded-lg shadow-md">
                        ...
                        <div id="imagePreview" class="mt-4 hidden">
                            ...
                            <img id="preview" class="max-w-full h-auto max-h-64 rounded-lg border border-gray-300" src="" alt="Preview Gambar Baru">
                        </div>
                    </div>
